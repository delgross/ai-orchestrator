...
from agent_runner.agent_runner import get_shared_engine, get_shared_state # Shim accessors
    ...
    try:
        ...
        if hasattr(state, "memory") and state.memory:
            try:
                ...
                # [FIX] Do not re-enable servers explicitly disabled by the user
...
if __name__ == "__main__":
    ...
    reload_enabled = os.getenv("AGENT_RUNNER_RELOAD", "false").lower() == "true"
    uvicorn.run("agent_runner.main:app", host="127.0.0.1", port=port, reload=reload_enabled)
