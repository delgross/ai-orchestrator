...
### Watchdog
*   **Definition**: A background process that monitors specific directories (e.g., `ingest/`) for file system events.
*   **Role**: Triggers the ingestion pipeline automatically on file change, ensuring Memory synchronization.
...
*   **Active Brain**: `Grok 2 (xai:grok-2-1212)`. The default persona you chat with.
